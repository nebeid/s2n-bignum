...
#define MAX_REPS 512
static uint8_t input[MAX_BLOCKS * BLOCK + 64] __attribute__((aligned(64)));
static uint8_t output[NV][MAX_BLOCKS * BLOCK + 64] __attribute__((aligned(64)));
static uint8_t work_output[NV][MAX_BLOCKS * BLOCK + 64]
...
int main(int argc, char **argv) {
    ...
    static const size_t blocks[] = {1, 2, 3, 4, 5, 6, 7, 8};
